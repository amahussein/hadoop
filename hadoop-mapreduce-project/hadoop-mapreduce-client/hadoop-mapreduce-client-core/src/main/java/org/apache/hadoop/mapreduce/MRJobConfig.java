...
public interface MRJobConfig {
  ...
  String MR_AM_TASK_ESTIMATOR_SMOOTH_LAMBDA_MS =
      MR_AM_PREFIX
          + "job.task.estimator.exponential.smooth.lambda-ms";
  long DEFAULT_MR_AM_TASK_ESTIMATOR_SMOOTH_LAMBDA_MS =
      1000L * 60;
  long DEFAULT_MR_AM_TASK_ESTIMATOR_SIMPLE_SMOOTH_LAMBDA_MS =
      1000L * 120;
   ...
   */
  int DEFAULT_MR_AM_TASK_ESTIMATOR_SIMPLE_SMOOTH_INITIALS =
      24;
