...
public class TestMRIntermediateDataEncryptionTemp {
...
//  }
   ...
   */
//  public TestMRIntermediateDataEncryptionTemp(String testName, int mappers,
...
//        TestMRIntermediateDataEncryptionTemp.class,
//        NUM_NODES, conf);
//  }
//
//  @AfterClass
...
//  }
  ...
  public void testMerge() throws Exception {
    ...
    job.setMapperClass(TestMRIntermediateDataEncryptionTemp.MyMapper.class);
    job.setPartitionerClass(
        TestMRIntermediateDataEncryptionTemp.MyPartitioner.class);
